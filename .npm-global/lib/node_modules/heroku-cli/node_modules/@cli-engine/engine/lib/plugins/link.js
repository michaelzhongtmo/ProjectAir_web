...
class LinkPlugins {
    ...
    _init() {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            this.debug('init');
            this.plugins = ts_lodash_1.default.compact(yield Promise.all(deps_1.default.util.objValues(yield this.manifestPlugins()).map(v => {
    ...
    removePlugin(name) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            yield this.manifest.set('plugins', plugins);
            yield this.manifest.save();
            yield deps_1.default.file.remove(path.join(this.config.dataDir, 'plugins', 'link', `${name}.json`));
            delete this.plugins;
        });
    }
    manifestPlugins() {
...
], LinkPlugins.prototype, "_init", null);
