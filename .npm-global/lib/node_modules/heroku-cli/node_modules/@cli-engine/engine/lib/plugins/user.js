...
class UserPlugins {
    ...
    update() {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            const packages = deps_1.default.util.objEntries(yield this.manifestPlugins()).map(([k, v]) => `${k}@${v.tag}`);
            yield this.yarn.exec(['upgrade', ...packages]);
...
], UserPlugins.prototype, "fetchPlugins", null);
