...
class RWLockfile {
    ...
    check(type) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            if (status.status === 'open')
                ...
                if (!(yield pidActive(status.job.pid))) {
    ...
    _lock(type, opts) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            while (true) {
                try {
                    yield this._tryLock(type, opts.reason);
                    return;
                }
                catch (err) {
                    if (err.code !== 'ELOCK')
...
tslib_1.__decorate([
    decorators_1.lockfile('internal')
], RWLockfile.prototype, "_tryLock", null);
tslib_1.__decorate([
    decorators_1.lockfile('internal', { sync: true })
...
function pidActiveWindows(pid) {
    return new Promise((resolve, reject) => {
        const p = child_process_1.spawn('tasklist', ['/fi', `PID eq ${pid}`]);
        p.on('close', code => {
            if (code !== 0)
...
function pidActiveWindowsSync(pid) {
    const { stdout, error, status } = child_process_1.spawnSync('tasklist', ['/fi', `PID eq ${pid}`], {
        stdio: [0, null, 2],
        encoding: 'utf8',
    });
    if (error)
