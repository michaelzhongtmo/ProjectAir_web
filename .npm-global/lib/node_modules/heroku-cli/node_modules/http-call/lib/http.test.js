...
describe('HTTP.get()', () => {
    ...
    test('can build a new default class', () => tslib_1.__awaiter(this, void 0, void 0, function* () {
        const MyHTTP = http_1.HTTP.defaults({ host: 'api.jdxcode.com' });
        api.get('/')
            .reply(200, { message: 'ok' });
...
describe('HTTP.parseBody()', () => {
    ...
    beforeEach(() => {
        ...
        http = new http_1.HTTP('www.duckduckgo.com', { 'body': body });
    });
